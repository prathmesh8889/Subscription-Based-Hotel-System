...
export function OwnerSettingsPage(){
  ...
  return <div className="space-y-4 sm:space-y-6 max-w-5xl min-w-0">
    ...
    <form onSubmit={saveProfile} className="bg-white border rounded-xl p-4 sm:p-5 space-y-4">
      ...
      <button disabled={saving} className="w-full sm:w-auto px-5 py-2.5 bg-amber-500 text-white rounded-lg flex items-center justify-center gap-2"><Save size={17}/>{saving?'Saving...':'Save Profile'}</button>
    </form>

    <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
      <form onSubmit={changePassword} className="bg-white border rounded-xl p-4 sm:p-5 space-y-3">
