...
export function AdminClientsPage(){
  ...
  return <div className="space-y-4 sm:space-y-5 min-w-0">
    <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
      ...
      <div className="grid grid-cols-2 sm:flex gap-2"><button onClick={load} className="border rounded-lg px-3 py-2 flex gap-2 items-center justify-center"><RefreshCw size={16}/>Refresh</button><button onClick={()=>setShow(v=>!v)} className="bg-purple-600 text-white rounded-lg px-4 py-2 flex gap-2 items-center justify-center"><Plus size={16}/>Add Client</button></div>
    </div>
    ...
    {show&&<div className="bg-white border rounded-xl p-4 sm:p-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
    ...
    <div className="bg-white border rounded-xl overflow-x-auto">
      <table className="w-full min-w-[760px] text-sm"><thead className="bg-gray-50"><tr><th className="text-left p-3">Client</th><th className="text-left p-3">Login</th><th className="text-left p-3">Subscription</th><th className="text-left p-3">Usage</th><th className="text-left p-3">Status</th></tr></thead><tbody>
